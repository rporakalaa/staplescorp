...
public class mangus extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("mangus", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getManguslogoutclick().click();
		Thread.sleep(2000);
		login.getManguslogoutlinkclick().click();
