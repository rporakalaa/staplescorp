...
public class staples_SolutionBuilder extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("SolutionBuilder", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getSolutionbuilderlogoutclick().click();
		Thread.sleep(2000);
		login.getSolutionbuilderlogoutpopupclick().click();
		Thread.sleep(2000);
