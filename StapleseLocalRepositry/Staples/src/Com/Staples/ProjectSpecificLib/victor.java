...
public class victor extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("VICTOR", "URL", 2));	   
		...
		waitForclassname(Baseclass.driver, "ng-binding");
		Thread.sleep(6000);
		login.getVictorlogoutclick().click();
		Thread.sleep(3000);
		login.getVictorlogoutlinkclick().click();
		Thread.sleep(2000);
