...
public class corner extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("CORNERSTONE", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
	/*	login.getCornerlogoutclick().click();
		Thread.sleep(2000); 
		login.getCornerlogoutlinkclick().click();*/
		Thread.sleep(2000);
