...
public class edsMedallia extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("EDSMedallia", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getEdslogoutclick().click();
		Thread.sleep(3000);
		login.getEdslogoutlinkclick().click();				
		waitForPageToLoad(Baseclass.driver);
		login.getEdslogoutclick().click();
		Thread.sleep(3000);
		login.getEdslogoutlinkclick().click();	
