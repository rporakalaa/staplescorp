...
public class bitbucket extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("BITBUCKET", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getBitlogoutclick().click();
		Thread.sleep(2000);	
		login.getBitlogoutlinkclick().click();
		Thread.sleep(2000);	
