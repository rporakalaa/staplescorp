...
public class cams extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("CAMS", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getCamslogoutlinkclick().click();
		Thread.sleep(2000);
		//aceptAlert(Baseclass.driver);
		//login.getCamslogoutbuttonclick().click();
