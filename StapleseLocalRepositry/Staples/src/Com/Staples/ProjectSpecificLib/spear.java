...
public class spear extends CommonLibs

{
	...
	public void staplesLoginTest(String Username, String Password) throws InterruptedException, InvalidFormatException, IOException
	{
	    ...
	    Baseclass.driver.get(ExcelLib.getExcelData("spear", "URL", 2));	   
		...
		waitForPageToLoad(Baseclass.driver);
		login.getSpearlogoutclick().click();
		Thread.sleep(2000);
		login.getSpearlogoutlinkclick().click();
		Thread.sleep(2000);
